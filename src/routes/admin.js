...
// Initialize with official admin user Martin
// Password: Martin@21 (Full Access Super Admin - MCA)
// Martin can add only ONE PA (admin role)
let devUsers = [
  { 
    id: 1, 
    name: 'Martin', 
    phone: '0700000000', // Official admin identifier
    pin_hash: '$2a$10$71xfcEFfaGvGZea03GFoXeTH485vDPc0hVpGQqmzx9mr4xIU7n8Dy', // bcrypt hash of 'Martin@21'
    role: 'super_admin', 
